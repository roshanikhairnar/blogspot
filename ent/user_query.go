...
func (uq *UserQuery) QueryBlogs() *BlogsQuery {
...
func (uq *UserQuery) WithBlogs(opts ...func(*BlogsQuery)) *UserQuery {
	query := (&BlogsClient{config: uq.config}).Query()
...
func (uq *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := uq.withBlogs; query != nil {
		if err := uq.loadBlogs(ctx, query, nodes,
			func(n *User) { n.Edges.Blogs = []*Blogs{} },
			func(n *User, e *Blogs) { n.Edges.Blogs = append(n.Edges.Blogs, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (uq *UserQuery) loadBlogs(ctx context.Context, query *BlogsQuery, nodes []*User, init func(*User), assign func(*User, *Blogs)) error {
